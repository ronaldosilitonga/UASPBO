...
public class FormPulsa extends javax.swing.JFrame {
    ...
    private void konfirmasiButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_konfirmasiButtonActionPerformed
        ...
        newdata.setOperatorPulsa(operatorComboBox.getSelectedItem().toString());
        newdata.setNoTelp(noTelpTextField.getText());
        newdata.setNominalPulsa(nominalPulsa);
        
        thrown.setNominalPulsaThrown(nominalPulsa);
        thrown.setOperatorPulsaThrown(newdata.getOperatorPulsa());
        thrown.setNoTelpThrown(newdata.getNoTelp());
        dispose(); 
