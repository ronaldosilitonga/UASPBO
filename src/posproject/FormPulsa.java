...
public class FormPulsa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        operatorComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Operator -", "Telkomsel", "Tri", "XL", "Smartfren" }));
        ...
        nominalComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Nominal -", "5.000", "10.000", "20.000", "50.000", "100.000" }));
        ...
        layout.setHorizontalGroup(
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(131, 131, 131)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(operatorComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 232, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(nominalComboBox, 0, 232, Short.MAX_VALUE)
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(235, 235, 235)
                .addComponent(konfirmasiButton, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(konfirmasiButton, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(64, 64, 64))
        );
    ...
    private void konfirmasiButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_konfirmasiButtonActionPerformed
        // TODO add your handling code here:
        setOperatorPulsa(operatorComboBox.getSelectedItem().toString());
        setNomorTelepon(noTelpTextField.getText());
        setNominalPulsa(nominalComboBox.getSelectedItem().toString());
        
        POSFrame posframe = new POSFrame();
        String operator = getOperatorPulsa();
        String nomor = getNomorTelepon();
        String nominal = getNominalPulsa();
    }//GEN-LAST:event_konfirmasiButtonActionPerformed

    
    // Pass the retrieved data to the main form
    /**
    ...
    private void setNomorTelepon(String text) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    private void setNominalPulsa(String toString) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    private void setOperatorPulsa(String toString) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    private String getOperatorPulsa() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    private String getNominalPulsa() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
